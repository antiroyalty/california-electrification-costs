...
process("baseline", "single-family-detached", socal_counties, output_base_dir="data", download_new_files=True) # output directory should just be 'data', not 'loadprofiles'