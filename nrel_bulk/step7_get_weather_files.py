    ...
    for county in counties:
        ...
        try:
            ...
            if response.status_code == 200:
                file_path = os.path.join(output_dir, county, f"weather_TMY_{county}.csv")
...
process("../data/nrel/upgrade0", "../data/nrel/weather", norcal_counties)