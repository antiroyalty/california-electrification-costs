...
SCENARIOS = {
    ...
    "induction_stove_coopt": {"gas": {"hot_water", "heating"}, "electric": {"appliances", "misc", "cooking"}},
    "water_heating_coopt": {"gas": {"cooking", "heating"}, "electric": {"hot_water", "appliances", "misc"}},
    "heat_pump_coopt": {"gas": {"hot_water", "cooking"}, "electric": {"appliances", "misc", "heating"}},
    "heat_pump_and_induction_stove_and_water_heating_coopt": {"gas": set(), "electric": {"hot_water", "cooking", "heating", "appliances", "misc"}},
    "baseline_ice_car_coopt": {"gas": {"heating", "hot_water", "cooking", "vehicle_fuel"}, "electric": {"appliances", "misc"}},
    "baseline_ev_car_coopt": {"gas": {"heating", "hot_water", "cooking"}, "electric": {"appliances", "misc", "vehicle_charging"}},
     "full_electric_ev_coopt": {"gas": set(), "electric": {"hot_water", "cooking", "heating", "appliances", "misc", "vehicle_charging"}},
}
